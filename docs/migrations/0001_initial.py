    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='docs.cartaportedoc')),
                ('remitente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='docs.empresa')),
            ],
        ),
        migrations.CreateModel(
            name='Manifiesto',
            fields=[
                ...
                ('numero', models.CharField(max_length=20)),
                ('fecha_emision', models.DateField(default=datetime.date.today)),
                ('documento', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='docs.manifiestodoc')),
                ('remolque', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='remolque', to='docs.vehiculo')),
                ('vehiculo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vehiculo', to='docs.vehiculo')),
            ],
        ),
    ]
